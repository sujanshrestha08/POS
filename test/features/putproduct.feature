...
npm run test
  ...
  Scenario Outline: Put Product
    * Put to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                   | data                                                                                                                                                                              | expectval                                          |
      | http://localhost:3000/product/1 |  {"barcode":890,"itemname":"kellogs Moon and Star","category":"food","size":"Large","manufacturer":"kellogs","price":300,"quantity":4,"total":"(4*280)","bought":280,"discount":"10%" } | {  "status": 200} |