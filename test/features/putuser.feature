...
2. run the following command:
  ...
  Scenario Outline: Put Product update
    * Put to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                           | data                                                                                                                                                        | expectval         |                                                                              
      | http://localhost:3000/users/3 |{ "email":"magaranub@gmail.com","password":"12345","fullname":"Anubhav","address":"Thaiba","phone":"98601234021","usertype":"memeber","membership":"5" }    | {  "status": 200} |
