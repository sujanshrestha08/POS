...
npm run test
  ...
  Scenario Outline: Post Analyze register
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                           | data                                                                                                                                                                                   | expectval                                             |
      | http://localhost:3000/analyze | {"bill":123456789,"cashier":"anubhav","quantity":4,"total":"(4*300)","profit":"300-280","discount":"10%" } | {  "status": 201} |